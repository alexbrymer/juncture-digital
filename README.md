...
**A (free) Github account** - Juncture uses Github, a file hosting service with many [features](https://github.com/jstor-labs/juncture/wiki/Github-overview), to store visual essays.
